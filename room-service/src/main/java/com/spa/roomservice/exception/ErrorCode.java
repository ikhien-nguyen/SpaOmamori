package com.spa.roomservice.exception;
...
public enum ErrorCode {
    ...
    TREATMENT_NOT_EXISTED(1030, "Không tìm thấy dịch vụ trị liệu", HttpStatus.NOT_FOUND),
    ROOM_NOT_EXISTED(1040, "Không tìm thấy phòng", HttpStatus.NOT_FOUND),
    ROOM_NAME_EXISTED(1041, "Tên phòng đã tồn tại, vui lòng chọn tên khác", HttpStatus.BAD_REQUEST),
    ROOM_INACTIVE(1042, "Phòng này đã ngừng sử dụng", HttpStatus.BAD_REQUEST),
    ;
